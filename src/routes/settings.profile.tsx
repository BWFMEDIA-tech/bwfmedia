      ...
      <aside className="space-y-4">
        <div className="overflow-hidden rounded-xl border border-white/10 bg-white/[0.02]">
          ...
          <div className="pt-12 px-4 pb-4 text-center">
            ...
            <a href={username ? `/user/${username}` : "/profile"} className="mt-3 block w-full rounded-lg bg-red-600 py-2 text-center text-xs font-bold uppercase tracking-wider text-white hover:bg-red-500">View Profile</a>
          </div>
        </div>
